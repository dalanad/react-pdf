...
const configBase = {
  external: [
    ...
    '@paladin-analytics/textkit/lib/layout',
    '@paladin-analytics/textkit/lib/renderers/pdf',
    '@paladin-analytics/textkit/lib/attributedString',
    '@paladin-analytics/textkit/lib/engines/linebreaker',
    '@paladin-analytics/textkit/lib/engines/justification',
    '@paladin-analytics/textkit/lib/engines/textDecoration',
    '@paladin-analytics/textkit/lib/engines/scriptItemizer',
    '@paladin-analytics/textkit/lib/engines/wordHyphenation',
    '@paladin-analytics/textkit/lib/run/advanceWidth',
    '@paladin-analytics/textkit/lib/attributedString/advanceWidth',
