...
const configBase = {
  external: [
    ...
    '@paladin-analytics/rpdf-textkit/lib/layout',
    '@paladin-analytics/rpdf-textkit/lib/renderers/pdf',
    '@paladin-analytics/rpdf-textkit/lib/attributedString',
    '@paladin-analytics/rpdf-textkit/lib/engines/linebreaker',
    '@paladin-analytics/rpdf-textkit/lib/engines/justification',
    '@paladin-analytics/rpdf-textkit/lib/engines/textDecoration',
    '@paladin-analytics/rpdf-textkit/lib/engines/scriptItemizer',
    '@paladin-analytics/rpdf-textkit/lib/engines/wordHyphenation',
    '@paladin-analytics/rpdf-textkit/lib/run/advanceWidth',
    '@paladin-analytics/rpdf-textkit/lib/attributedString/advanceWidth',
