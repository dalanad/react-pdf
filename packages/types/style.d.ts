export interface Style {
  ...
  /**
   * Inside margin. Dynamically changes between right or left based on the page
   */
  marginInside?: number | string;

  /**
   * Outside margin. Dynamically changes between right or left based on the page
   */
